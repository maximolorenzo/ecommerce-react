...
const Item = ({products}) => {
    ...
    <div className=" m-5 justify-center max-w-xl rounded-lg shadow-md bg-gray-800 border-gray-700">
    
    <img  className="object-cover h-72 w-full" src={products.image} alt="" />
    
    <div className="px-5 pb-5"> 
        
            <h5 className="text-xl font-semibold tracking-tight text-white">{products.product}</h5>
        
        
        <div className="flex justify-between items-center">
            <span className="text-3xl font-bold text-white">{products.price} USD</span>
